...
<div class="container mt-5">
    <h2 class="text-center mb-4" style="color:rgb(88, 114, 44);"> Medicine Request</h2><br>
    <table class="table">
        <thead>
            <tr>
                <th scope="col">ID</th>
        ...
        <tbody>
            ...
            $query = "SELECT * FROM medicine_purchase";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row['bkash_txn_number'] . "</td>";
                    
                    // Edit button
                    // echo "<td><a href='edit_user.php?id=" . $row['id'] . "' class='btn btn-success btn-sm'>Edit</a>";
                    // // Delete button
                    // echo "<a href='delete_user.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm ml-1'>Delete</a></td>";
                    // echo "</tr>";
                }
            } else {
