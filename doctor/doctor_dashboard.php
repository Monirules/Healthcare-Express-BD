...
if (isset($_SESSION['doctor_id'])) {
    ...
    $query = "SELECT name, email, category, room_no, schedule, schedule2 FROM doctor WHERE doctor_id= ?";
    ...
    $stmt->bind_result($name, $email, $category, $room_no, $schedule, $schedule2);
...
<div class="content">
    <h3 style="text-align: center; color:brown; margin-top: 3%;">Doctor Profile</h3>
