...
<div class="container mt-5">
    <h2 class="text-center mb-4" style="color:rgb(88, 114, 44);">Live Search Doctors</h2><br>
    
    <div class="container mt-5">
        <input type="text" id="searchInput2" class="form-control mb-3" placeholder="Search any doctor...">
